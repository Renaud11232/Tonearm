...
class JumpCommand(InjectorCog):
    ...
    async def jump(self,
                   ...
                   track: app_commands.Transform[int | None, ZeroIndexTransformer] = None):
    ...
    async def __jump(self, interaction: discord.Interaction, track: int):
